...
As you experiment with smaller staps, as you become more comfortable with them, you will see, and feel, their benefits. You'll be a better programmer and happier programmer by taking smaller steps.
--
