...
Sometimes that reaction will be quite negative. It might be very positive, although often in a qualified way - _this is good, but could it ..._ Nobody has ever passed over a piece of software and people have used it and say _yes, this is perfect, your work here is done_
...
Those thoughtspaces we can explore? The people we work have their own thoughtspaces, their imagination is just as rich as ours, but each us can only see so far. As we work together, the code we write, as we manifest those thoughts, that changes the immediate landscape we can see, opens up new paths, makes it apparent that other directions are less useful, gives us a glimpse over the hill. That's part of the power of the software we write.
