...
This might sound like a counsel of despair. No rules? Then surely in the grim dark future there is only war? (And, honestly, some of the stories you hear might lead you to this conclusion.) While there may not be rules, we can apply some guidelines, some heuristics, some practices.
...
[NOTE.speaker]
--
At the risk of sounding like a grumpy old man, many of the names and phrases we use in software development have become devalued almost to the point of meaningless. Continuous Delivery has somehow come to mean using CircleCI to build your Docker images, or DevOps has comes to mean, well, Ops. In many places and too many people Test Driven Development has, sadly, come to mean writing a couple of unit tests before you commit.
...
[NOTE.speaker]
--
I want to touch on one last thing before I finish. A lot of what I've talked about has explicitly or implicitly implied that we're all working in one unified team in an organisation with clear priorities, engaged users and all that. I understand, believe me I understand, that this is not the case for all of us. Or probably any of us. However, these practices that I've talked, you can apply them at an individual level too. You can't leap from nothing into _boompf_ our whole code base now has a wonderful test scaffolding, but you can the maxim of doing the simplest thing. You can apply TDD to a leaf class, perhaps. You can observe and modify your own behaviour - am I improving the design, am I changing the functionality.

And you will see, and you will feel, the benefits of the practices.
--
