...
Write as much software as you need, but only as much as you need. If we can do that, then what we write will necessarily tend toward the simplest it can be. 
--
